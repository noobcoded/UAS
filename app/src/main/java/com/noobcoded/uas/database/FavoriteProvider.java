...
public class FavoriteProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(DatabaseContact.AUTHORITY, FavoriteColumn.TABLE_NAME, FAVORITE);
        sUriMatcher.addURI(DatabaseContact.AUTHORITY, FavoriteColumn.TABLE_NAME + "/#", FAVORITE_ID);
    }
